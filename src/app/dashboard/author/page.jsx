...
const VarifyauthorPage = () => {
  ...
  return (
    <div className={styles.container}>
      <h1 className={styles.title}>Manage Varifyauthor</h1>
      <form className={styles.form} onSubmit={isEditing ? handleEdit : handleAdd}>
        <input
          type="text"
          name="name"
          placeholder="Name"
      ...
      <div className={styles.list}>
        {varifyAuthors.map((author) => (
          <div key={author.id} className={styles.card}>
            ...
            <p className={styles.authorExperience}>{author.experience}</p>
            <p className={styles.authorMessage}>{author.message}</p>
            <button onClick={() => handleEditClick(author)} className={styles.editButton}>
              Edit
            </button>
            <button onClick={() => handleDelete(author.id)} className={styles.deleteButton}>
              Delete
            </button>
          </div>
        ))}
