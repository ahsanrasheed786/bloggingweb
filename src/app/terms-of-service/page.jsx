  ...
  return (
    <div className={styles.container}>
      ...
      <p className={styles.para}>
        Welcome to <span className={styles.coolzonemaster}>CoolZoneMaster!</span> These Terms of Service govern your use of our website and services. By accessing or using our website, you agree to comply with these terms and conditions.
      </p>
      ...
      <p className={styles.para}>
      <span className={styles.coolzonemaster}>CoolZoneMaster</span> is not liable for any direct, indirect, incidental, or consequential damages arising from the use of or inability to use our website or services. Your use of the site is at your own risk.
      </p>
      ...
      <p className={styles.para}>
        If you have any questions about these Terms of Service, please contact us at <a href={`mailto:${process.env.EMAIL}`} className={styles.coolzonemaster}>{process.env.EMAIL}</a>.
      </p>
    </div>
  );
};
